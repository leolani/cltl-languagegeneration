...
def simple_nlg(subject, predicate, complement=None, modifier=None, negation=False, question=None, tense=None, perfect=False):
...
class SimpleNLGReplier(BasicReplier):
        ...
        # There is a conflict, so we phrase it
            ...
            say += ' %s told me on %s that %s But now you tell me that %s' \
                   % (x, conflict['_provenance']['_date'],
                      ...
                      simple_nlg(y, utterance['triple']['_predicate']['_label'], utterance['triple']['_complement']['_label']))
            ...
            if affirmative_conflict and negative_conflict:
                ...
                say += ' %s told me on %s that %s But on %s %s told me that %s' \
                       % (affirmative_conflict['_provenance']['_author']['_label'],
                          ...
                          simple_nlg(utterance['triple']['_subject']['_label'], utterance['triple']['_predicate']['_label'],
    ...
    def _phrase_overlaps(all_overlaps, utterance):
        ...
        if not overlaps:
            ...
            say += ' Now I know %s items that %s For example %s and %s.' % (len(overlaps),
            ...
            say += ' Now I know %s %s %s For example %s and %s.' % (len(overlaps), types,
